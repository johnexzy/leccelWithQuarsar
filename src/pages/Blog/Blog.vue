<template>
  <q-page>
    ...
    <section class="q-pt-xl q-pb-xs">
      <div class="container">
        <router-link
          :to="{
            name: 'blog',
            query: { categories: Object.keys(Post.categories)[0].toLocaleLowerCase() },
          }"
          class="text-subtitle1 text-para-default"
        ...
        <div class="row items-center q-my-md">
          ...
          <div class="text-subtitle1 text-para-default q-mx-md">•</div>
      ...
      <div class="container">
        <div class="row q-col-gutter-lg">
          <div class="col-12 col-md-3 col-lg-3 column items-start">
            <div class="text-subtitle1 text-para-default q-mb-md">SHARE THIS ARTICLE</div>
            <a
              ...
              target="_blank"
              ><q-icon size="25px" name="ion-logo-facebook" class="q-mr-md" />Facebook</a
            >
            <a
              class="share-btn q-mb-sm"
              :href="`http://twitter.com/intent/tweet/?text=${shareInfo.text} \n${shareInfo.link}`"
              target="_blank"
              ><q-icon size="25px" name="ion-logo-twitter" class="q-mr-md" />Twitter</a
            >
            <a
              class="share-btn q-mb-sm"
              :href="`https://www.linkedin.com/sharing/share-offsite/?url=${shareInfo.link}`"
              target="_blank"
              ><q-icon size="25px" name="ion-logo-linkedin" class="q-mr-md" />Linkedin</a
            >
            <a
              class="share-btn q-mb-sm"
              target="_blank"
            ...
            <a
              ...
              ><q-icon size="25px" name="ion-logo-whatsapp" class="q-mr-md" />Whatsapp</a
            >
          </div>
          <div class="col-12 col-md-6 col-lg-6">
            <div v-html="Post.content" class="blog-html html" />

            <div class="q-my-xl">last updated on: {{ timeAgo(Post.modified) }}</div>
    ...
    <section class="q-py-xl">
      <div class="container">
        <div class="text-subtitle1 text-default q-mb-xl">FEATURED POSTS</div>
        <div class="row q-col-gutter-lg">
          <div v-for="(s, i) in FeaturedPosts" :key="i" class="col-12 col-md-3 col-lg-3">
            ...
            <div>
              <q-img
                ...
                @click="$router.push({ name: 'blogs.blog', params: { blog: s.slug } })"
            ...
            <router-link
              ...
              class="text-subtitle1 text-default text-weight-bold text-black"
            >
              {{ s.title }}
            </router-link>
